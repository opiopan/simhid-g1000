...
boards=[
    ('../individuals/CAMOutputs/simhid-g1000_bottom.', 0, 0, 0),
]
outline = gerberex.read('../individuals/CAMOutputs/simhid-g1000_bottom.GML')
outputs = 'outputs/bottom/pcb'

if not os.path.isdir('outputs'):
    os.mkdir('outputs')
if not os.path.isdir('outputs/bottom'):
    os.mkdir('outputs/bottom')
